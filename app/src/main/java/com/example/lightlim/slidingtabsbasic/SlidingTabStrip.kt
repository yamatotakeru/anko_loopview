...
public class SlidingTabStrip @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : LinearLayout(context, attrs) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val tabColorizer: SlidingTabLayout.TabColorizer = if (mCustomTabColorizer != null) mCustomTabColorizer!! else mDefaultTabColorizer
