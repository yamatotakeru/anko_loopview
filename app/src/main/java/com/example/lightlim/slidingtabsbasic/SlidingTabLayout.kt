...
import com.example.lightlim.slidingtabsbasic.SlidingTabLayout.TabColorizer
 ...
 */
public class SlidingTabLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : HorizontalScrollView(context, attrs, defStyle) {
     ...
     */
    fun setViewPager(viewPager: LoopViewPager?) {
